...
Sample Grant Agreeement using DFSM (see https://github.com/Consensys-Network-State/signet-data-standard/blob/master/templates/grant-agreement.json as input)
