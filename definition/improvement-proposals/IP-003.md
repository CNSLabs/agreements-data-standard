...
1. **Transaction Proof Definition** - Specifies what type of proof is required for a state machine to progress
```tsx
// Core proof components
...
2. **Transaction Proof Instance** - The actual proof data provided as input that satisfies the definition
